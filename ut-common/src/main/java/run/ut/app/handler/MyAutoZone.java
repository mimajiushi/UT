...
public class MyAutoZone extends MyZone {
    public static MyAutoZone instance = new MyAutoZone();
     ...
     */
    private Map<String, MyZone> inferDomainsMap;
    ...
    public MyAutoZone(String ucServer) {
    ...
    public String getRsHttp(ZoneReqInfo zoneReqInfo) {
        ...
        MyZone zone = this.inferDomainsMap.get(info.upHttp);
        if (zone != null) {
