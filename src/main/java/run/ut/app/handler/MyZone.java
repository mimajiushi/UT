...
public class MyZone extends Zone implements Serializable {
    ...
    public static class Builder {
        ...
        public Builder(MyZone originZone) {
            this();
        ...
        public MyZone.Builder region(String region) {
            zone.region = region;
            return this;
        }

        public MyZone.Builder upHttp(String upHttp) {
            zone.upHttp = upHttp;
            return this;
        }

        public MyZone.Builder upBackupHttp(String upBackupHttp) {
            zone.upBackupHttp = upBackupHttp;
            return this;
        }

        public MyZone.Builder upHttps(String upHttps) {
            zone.upHttps = upHttps;
            return this;
        }

        public MyZone.Builder upBackupHttps(String upBackupHttps) {
            zone.upBackupHttps = upBackupHttps;
            return this;
        }

        public MyZone.Builder upIpHttp(String upIpHttp) {
            zone.upIpHttp = upIpHttp;
            return this;
        }

        public MyZone.Builder upIpHttps(String upIpHttps) {
            zone.upIpHttps = upIpHttps;
            return this;
        }

        public MyZone.Builder iovipHttp(String iovipHttp) {
            zone.iovipHttp = iovipHttp;
            return this;
        }

        public MyZone.Builder iovipHttps(String iovipHttps) {
            zone.iovipHttps = iovipHttps;
            return this;
        }

        public MyZone.Builder rsHttp(String rsHttp) {
            zone.rsHttp = rsHttp;
            return this;
        }

        public MyZone.Builder rsHttps(String rsHttps) {
            zone.rsHttps = rsHttps;
            return this;
        }

        public MyZone.Builder rsfHttp(String rsfHttp) {
            zone.rsfHttp = rsfHttp;
            return this;
        }

        public MyZone.Builder rsfHttps(String rsfHttps) {
            zone.rsfHttps = rsfHttps;
            return this;
        }

        public MyZone.Builder apiHttp(String apiHttp) {
            zone.apiHttp = apiHttp;
            return this;
        }

        public MyZone.Builder apiHttps(String apiHttps) {
         ...
         * 自动选择,其它参数设置无效
         */
        public MyAutoZone autoZone() {
            return MyAutoZone.instance;
        }
     ...
     * 华东机房相关域名
     */
    public static MyZone zone0() {
        return new MyZone.Builder().region("z0").upHttp("http://up.qiniu.com").upHttps("https://up.qbox.me").
     ...
     * 华东机房内网上传相关域名
     */
    public static MyZone qvmZone0() {
        return new MyZone.Builder().region("z0").upHttp("http://free-qvm-z0-xs.qiniup.com").
     ...
     * 华东机房内网上传相关域名
     */
    public static MyZone qvmHuadong() {
        return qvmZone0();
    }
     ...
     * 华北机房相关域名
     */
    public static MyZone zone1() {
        return new MyZone.Builder().region("z1").upHttp("http://up-z1.qiniu.com").upHttps("https://up-z1.qbox.me").
     ...
     * 华北机房内网上传相关域名
     */
    public static MyZone qvmZone1() {
        return new MyZone.Builder().region("z1").upHttp("http://free-qvm-z1-zz.qiniup.com").
     ...
     * 华北机房内网上传相关域名
     */
    public static MyZone qvmHuabei() {
        return qvmZone1();
    }
     ...
     * 华南机房相关域名
     */
    public static MyZone zone2() {
        return new MyZone.Builder().region("z2").upHttp("http://up-z2.qiniu.com").upHttps("https://up-z2.qbox.me").
     ...
     * 北美机房相关域名
     */
    public static MyZone zoneNa0() {
        return new MyZone.Builder().region("na0").upHttp("http://up-na0.qiniu.com").upHttps("https://up-na0.qbox.me").
     ...
     * 新加坡相关域名
     */
    public static MyZone zoneAs0() {
        return new MyZone.Builder().region("as0").upHttp("http://up-as0.qiniu.com").upHttps("https://up-as0.qbox.me").
     ...
     */
    public static MyZone autoZone() {
        return new MyZone.Builder().autoZone();
    }
